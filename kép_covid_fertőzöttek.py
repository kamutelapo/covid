...
plot = dfheti.plot(x='Dátum', y='Heti új fertőzöttek átlaga', title="Új COVID fertőzöttek heti átlaga")	


fig = plot.get_figure()
fig.savefig(BASEDIR + "/képek/Fertőzöttek.png", bbox_inches = "tight")
