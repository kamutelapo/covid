...
plot = df.plot(x='Dátum', y=['Beoltottak', 'Kétszer oltottak', 'Háromszor oltottak'], ylim=[0, 6000000],
               title='A COVID ellen beoltottak összesen', color=['blue', 'orange', 'green'], grid=True)
